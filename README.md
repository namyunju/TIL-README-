...
# 개발 첫 걸음, 무엇에 집중해야 하는가.

낯선 개념. 개념만 이해해도 충분.
처음부터 모든 것을 이해하려 X. 간단히 이해하고 추후 필요할 때 다시 보면됨.


메모리, 성능 최적화보다 개발 경험이 우선. 
길이 같은 거에 얽매이지 말고 다양한 기능을 직접 완성해보는 개발 경험이 중요. 

AI와 함께 문제 해결 능력. 

깊이 파고들기

python을 왜 배우고 어떤 가치가 있는가 고민하기. 
컴퓨터에 명령을 내린다. 파이썬은 어떠한 문제를 해결하는 도구 중 하나
